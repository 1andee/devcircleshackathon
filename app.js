...
app.post('/webhook', function (req, res) {
  ...
  console.log(JSON.stringify('req.body.result', req.body.result));
  console.log(JSON.stringify("req.body['result'].parameters", req.body['result'].parameters));
  console.log(JSON.stringify("req.body['result']['parameters']", req.body['result']['parameters']));
  var data = req.body;
...
function receivedMessage(event) {
  ...
  if (bye && bye.confidence > 0.89) {
    ...
    sendTextMessage(senderID, 'Hi, I\'m Wall-e, your virtual assistant. How may I assist you? Type something I likely won\'t understand to get started.');
...
function showWhiteProducts (recipientId) {
  ...
  products.then(function(listOfProducts) {
        ...
        listOfProducts.forEach(function(product) {
          ...
          console.log(`productColor: ${product.options.color}`);
